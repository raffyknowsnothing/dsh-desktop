...
export const zh = {
  ...
  'archive.bulk': '归档全部会话 ({count})',
  'archive.bulkEmpty': '没有可归档的会话',
  'archive.bulkConfirm': '归档 {count} 个会话？',
  'archive.bulkConfirmAction': '全部归档',
  'archive.restore': '移出归档',
  'archive.restoreAll': '全部移出归档 ({count})',
  'archive.groupAria': '归档选项',
  'archive.rowAria': '{name} 的归档选项',
  save: '保存',
  cancel: '取消',
} as const
...
export const en: Record<WorkspaceDecorLocaleKey, string> = {
  ...
  'archive.bulk': 'Archive all sessions ({count})',
  'archive.bulkEmpty': 'No sessions to archive',
  'archive.bulkConfirm': 'Archive {count} conversations?',
  'archive.bulkConfirmAction': 'Archive all',
  'archive.restore': 'Move out of archive',
  'archive.restoreAll': 'Move all out of archive ({count})',
  'archive.groupAria': 'Archive options',
  'archive.rowAria': 'Archive options for {name}',
  save: 'Save',
  cancel: 'Cancel',
}
